...
- Fixed a case where a repository URL entered with an embedded access token could be written into scan logs and exports; such URLs are now rejected at input. ([#718](https://github.com/alpha-omega-security/scrutineer/pull/718), [@andrew](https://github.com/andrew); reported by [@abhinavgautam01](https://github.com/abhinavgautam01))
