...
func TestBundledSchemas_compileAndAcceptSamples(t *testing.T) {
	cases := []struct {
		...
		{
			"../../skills/poutine/schema.json",
			`{"findings":[{"id":"F1","title":"Code injection in a workflow step",
			  "severity":"Medium","location":".github/workflows/pr.yml:15",
			  "locations":[".github/workflows/pr.yml:15"],
			  "trace":"A pull request title reaches a shell step.",
			  "rating":"Medium from Poutine rule injection",
			  "references":[{"url":"https://github.com/boostsecurityio/poutine",
			    "summary":"Poutine rule injection","tags":"poutine,docs"}]}]}`,
		},
		{
...
func TestBundledSchemas_rejectBadShapes(t *testing.T) {
	cases := []struct {
		...
		{"../../skills/poutine/schema.json",
			`{"findings":[{"id":"F1","title":"Pipeline issue","severity":"Notice","location":"ci.yml:1"}]}`,
			"/findings/0/severity"},
		{"../../skills/security-deep-dive/schema.json",
			`{"repository":"https://github.com/o/r","commit":"abc1234","spec_version":13,
