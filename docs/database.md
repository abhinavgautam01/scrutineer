...
| severity_calibration_incomplete | boolean | True when an unknown, unresolved, not-attempted, or unavailable control input prevented complete calibration. Unknown inputs never lower severity. |
