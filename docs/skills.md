...
| `verify` | Re-checks one finding against current HEAD, records an evidenced attack tree, runs three isolated attempts, stores a five-criterion grading record and derives a score. |
